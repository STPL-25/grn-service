...
-- Approved POs pending receipt — shared by the GRN module and the Gate
-- Entry "search PO / show summary" screen. One row per PO, with an
-- `items` column holding a JSON array (frontend parses it if it's a string).
-- ============================================================
